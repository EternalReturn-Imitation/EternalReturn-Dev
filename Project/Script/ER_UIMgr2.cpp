...
void ER_UIMgr2::CreateInventorySlot()
{
...
void ER_UIMgr2::CreateInventoryItem()
{
...
void ER_UIMgr2::CreateEquipSlot()
{
...
void ER_UIMgr2::CreateEquipItem()
{
...
void ER_UIMgr2::CreateDropInventory()
{
...
void ER_UIMgr2::UpdateHPReturnBar()
{
...
Vec3 ER_UIMgr2::WorldPosToUIPos(Vec3 worldPos)
{
	// World 위치 벡터
